        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-white">
              ...
              <li>
                <a href="#about" className="hover:text-[hsl(var(--sunshine-yellow))] transition-colors">
                  • Courier Services in Ayr
                </a>
              </li>
              <li>
                <a href="#about" className="hover:text-[hsl(var(--sunshine-yellow))] transition-colors">
                  • Waste Removal in Kilmarnock
                </a>
              </li>
              <li>
                <a href="#about" className="hover:text-[hsl(var(--sunshine-yellow))] transition-colors">
                  • Delivery Services in Irvine
                </a>
              </li>
              <li>
                <a href="#about" className="hover:text-[hsl(var(--sunshine-yellow))] transition-colors">
                  • Van Services Ayrshire
                </a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              <a 
                ...
                onClick={() => trackExternalLink('https://www.facebook.com/profile.php?id=61578652119720', 'Facebook')}
